//This page contains the filterd product details
...
function Cards({filterdItems}) {
  const dispatch = useDispatch();
  return (
    <div 
    className='mx-auto m-auto  grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10 xl:gap-4 px-4'>
    {
